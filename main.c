...
void initSegment()
{
	...
	SEQUENCE_PRODUIT_TROIS = (OPERATION*)malloc(sizeof(OPERATION)*5);
	...
	SEQUENCE_PRODUIT_TROIS[0] = OP2;
	SEQUENCE_PRODUIT_TROIS[1] = OP2;
	SEQUENCE_PRODUIT_TROIS[2] = OP2;
	SEQUENCE_PRODUIT_TROIS[3] = OP2;
	SEQUENCE_PRODUIT_TROIS[4] = FINI;
